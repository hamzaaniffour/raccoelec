      ...
      <div className="max-w-7xl mx-auto">
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className=" bg-black">
              ...
              >
                <img
                  decoding="async"
                  className="w-10 h-10"
                  src="https://upload.wikimedia.org/wikipedia/fr/thumb/f/f7/Logo_TotalEnergies.svg/1200px-Logo_TotalEnergies.svg.png"
                  alt="Jese image"
                />
                <div className="ps-3">
              ...
              <td className="border-none  px-6 py-4">
                <div className="flex items-center justify-center flex-col">
                  <div className="text-white text-base font-semibold bg-green-500 px-3 rounded">
                    76 Jrs
                  </div>
            ...
            <tr className=" bg-black">
              <td className="border-none  w-4 p-4 text-center">
                <div className="w-6 h-6 bg-gray-400 rounded-full flex justify-center items-center text-white text-center">
                  2
                </div>
              </td>
              <th
                ...
                <div className="flex items-center justify-center flex-col">
                  <div className="text-gray-400 text-base font-semibold">
                    ...
                    >
                      ...
                      <g id="SVGRepo_iconCarrier">
                        <path
                          d="M3 8C2.44772 8 2 8.44772 2 9C2 9.55228 2.44772 10 3 10H21C21.5523 10 22 9.55228 22 9C22 8.44772 21.5523 8 21 8H3Z"
                          fill="#fbbf24"
                        />
                        <path
              ...
              <td className="border-none  px-6 py-4">
                <div className="flex items-center justify-center flex-col">
                  <div className="text-white text-base font-semibold bg-green-700 px-3 rounded">
                    76 Jrs
                  </div>
                  <div className="text-gray-400 text-sm font-normal">2022</div>
                </div>
            ...
            <tr className=" bg-black">
              <td className="border-none  w-4 p-4 text-center">
                <div className="w-6 h-6 bg-orange-600 rounded-full flex justify-center items-center text-white text-center">
                  3
                </div>
              </td>
              <th
              ...
              >
                <img
                  decoding="async"
                  className="w-8 h-8"
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/AXA_Logo.svg/1024px-AXA_Logo.svg.png"
                  alt="Jese image"
                />
                <div className="ps-3">
              ...
              <td className="border-none  px-6 py-4">
                <div className="flex items-center justify-center flex-col">
                  <div className="text-white text-base font-semibold bg-red-600 px-3 rounded">
                    76 Jrs
                  </div>
                  <div className="text-gray-400 text-sm font-normal">2022</div>
                </div>
            ...
            <tr className=" bg-black">
              ...
              >
                <img
                  decoding="async"
                  className="w-10 h-10"
                  src="https://infonet.fr/entreprises/759200934/image/entreprise/"
                  alt="Jese image"
                />
                <div className="ps-3">
            ...
            <tr className=" bg-black">
              ...
              >
                <img
                  decoding="async"
                  className="w-8 h-8"
                  src="https://infonet.fr/entreprises/582110987/image/entreprise/"
                  alt="Jese image"
                />
                <div className="ps-3">
            ...
            <tr className=" bg-black">
              ...
              >
                <img
                  decoding="async"
                  className="w-8 h-8"
                  src="https://infonet.fr/entreprises/542065479/image/entreprise/"
                  alt="Jese image"
                />
                <div className="ps-3">
                  <div className="text-base font-semibold uppercase">
